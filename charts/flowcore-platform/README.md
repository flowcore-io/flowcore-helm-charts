...
| `cassandra.metrics.image.repository`  | compatibility with bitnami migration                                       | `bitnamilegacy/cassandra-exporter` |
...
| `ensureCredentials.image.tag`                 | The image tag                                 | `1.13.0`                                      |
...
| `flowcore-microservices.deployments.eventSourceApi.env.COLD_STORAGE_API_URL`        | The cold storage API URL                | `http://cold-storage-api.flowcore:3000`                                                                              |
| `flowcore-microservices.deployments.eventSourceApi.env.COLD_STORAGE_TIMEOUT_MS`     | The cold storage timeout                | `255000`                                                                                                             |
...
| `flowcore-microservices.deployments.eventSourceActiveDataPump.deployment.tag`                                         | The tag                                              | `1.2.1`                                                    |
...
| `flowcore-microservices.deployments.eventSourceActiveDataPump.env.USE_SCAN_DATA_SOURCE`                               | The USE_SCAN_DATA_SOURCE                             | `true`                                                     |
| `flowcore-microservices.deployments.eventSourceActiveDataPump.env.SCAN_DATA_SOURCE_START_DATE`                        | The SCAN_DATA_SOURCE_START_DATE                      | `2025-03-20T00:00:00.000Z`                                 |
...
| `flowcore-microservices.deployments.coldStorageApi.deployment.tag`                 | The tag                                 | `2.13.0`                                                                 |
...
| Name                                                                                                                  | Description                                          | Value                                                      |
| --------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- | ---------------------------------------------------------- |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.enabled`                                                | Whether to install the event source active data pump | `true`                                                     |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.deployment.image`                                       | The image                                            | `service-active-data-pump`                                 |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.deployment.tag`                                         | The tag                                              | `1.2.1`                                                    |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.deployment.replicas`                                    | The number of replicas                               | `1`                                                        |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.service.enabled`                                        | Whether to enable the service                        | `true`                                                     |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.metrics.enabled`                                        | Whether to enable the metrics                        | `true`                                                     |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.metrics.port`                                           | The port for the metrics                             | `3000`                                                     |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.useTransports`                                          | The useTransports                                    | `nats`                                                     |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.env.FLOWCORE_API_KEY_ID`                                | The FLOWCORE_API_KEY_ID                              | `api-key-id in tenant-credentials secret`                  |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.env.FLOWCORE_API_KEY`                                   | The FLOWCORE_API_KEY                                 | `api-key-value in tenant-credentials secret`               |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.env.REDIS_URL`                                          | The REDIS_URL                                        | `redis-sentinel-rw in cold-storage-api-credentials secret` |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.env.DEFAULT_DATA_PUMP_MAX_REDELIVERY_COUNT`             | The DEFAULT_DATA_PUMP_MAX_REDELIVERY_COUNT           | `-1`                                                       |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.env.REDIS_KEY_PATTERN`                                  | The REDIS_KEY_PATTERN                                | `cold-storage-api-credentials`                             |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.env.ENDPOINT_HEADER_VALUE`                              | The ENDPOINT_HEADER_VALUE                            | `cold-storage-api-credentials`                             |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.env.ENDPOINT_OVERRIDE_URL`                              | The ENDPOINT_OVERRIDE_URL                            | `http://event-source-api:3000`                             |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.env.NO_TRANSLATION_MODE`                                | The NO_TRANSLATION_MODE                              | `true`                                                     |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.env.USE_SCAN_DATA_SOURCE`                               | The USE_SCAN_DATA_SOURCE                             | `true`                                                     |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.env.SCAN_DATA_SOURCE_START_DATE`                        | The SCAN_DATA_SOURCE_START_DATE                      | `2025-03-20T00:00:00.000Z`                                 |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.volumes.config`                                         | The configuration                                    | `{}`                                                       |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.volumes.cold-storage-active-data-pump-config.mountPath` | The mount path                                       | `/usr/src/app/.config`                                     |
| `flowcore-microservices.deployments.coldStorageActiveDataPump.volumes.cold-storage-active-data-pump-config.type`      | The type                                             | `configMap`                                                |
...
| `flowcore-microservices.deployments.webhookService.deployment.tag`                       | The image tag                          | `1.31.4`                                                       |
...
| `flowcore-microservices.deployments.serviceKubeLogApi.deployment.tag`                   | The image tag                               | `1.5.0`                                                                  |
...
| `flowcore-microservices.deployments.serviceDeleteManagerApi.env.POSTGRES_CONNECTION_STRING`          | The POSTGRES_CONNECTION_STRING                    | `postgres-connection-string in delete-manager-credentials secret`        |
| `flowcore-microservices.deployments.serviceDeleteManagerApi.env.INDEX_REDIS_URL`                     | The INDEX_REDIS_URL                               | `redis-sentinel-rw in delete-manager-credentials secret`                 |
