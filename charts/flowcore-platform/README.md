...
| `flowcore-microservices.deployments.ingestionChannel.env.FLOWCORE_TENANT_WEBHOOK_BASE_URL` | The Flowcore tenant webhook base URL              | `{}`                                                                        |
| `flowcore-microservices.deployments.ingestionChannel.env.FLOWCORE_TENANT_WEBHOOK_API_KEY`  | The Flowcore tenant webhook API key               | `{}`                                                                        |
