...
| `flowcore-microservices.deployments.serviceDeleteManagerApi.env.FLOWCORE_DEDICATED_LICENSE_KEY`      | The FLOWCORE_DEDICATED_LICENSE_KEY                | `tenant-license-key in tenant-credentials secret`                        |
...
| `flowcore-microservices.deployments.serviceDeleteManagerApi.env.LOCK_REDIS_URL`                      | The LOCK_REDIS_URL                                | `redis-url in service-delete-manager-api-credentials secret`             |
| `flowcore-microservices.deployments.serviceDeleteManagerApi.env.QUEUE_REDIS_URL`                     | The QUEUE_REDIS_URL                               | `redis-sentinel-rw in service-delete-manager-api-credentials secret`     |
