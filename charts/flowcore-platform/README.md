...
| `flowcore-microservices.deployments.webhookService.deployment.tag`                       | The image tag                          | `1.25.5`                                                       |
...
| `flowcore-microservices.deployments.serviceDeleteManagerApi.deployment.tag`                          | The image tag                                     | `1.0.8`                                                                           |
...
| `flowcore-microservices.deployments.serviceDeleteManagerApi.env.FLOWCORE_API_KEY`                    | The FLOWCORE_API_KEY                              | `flowcore-api-key in service-delete-manager-api-credentials secret`               |
...
| `flowcore-microservices.deployments.serviceDeleteManagerApi.env.FLOWCORE_DEDICATED_TENANT_ID`        | The FLOWCORE_DEDICATED_TENANT_ID                  | `flowcore-dedicated-tenant-id in service-delete-manager-api-credentials secret`   |
| `flowcore-microservices.deployments.serviceDeleteManagerApi.env.FLOWCORE_DEDICATED_LICENSE_KEY`      | The FLOWCORE_DEDICATED_LICENSE_KEY                | `flowcore-dedicated-license-key in service-delete-manager-api-credentials secret` |
| `flowcore-microservices.deployments.serviceDeleteManagerApi.env.SDK_API_KEY`                         | The SDK_API_KEY                                   | `sdk-api-key in service-delete-manager-api-credentials secret`                    |
| `flowcore-microservices.deployments.serviceDeleteManagerApi.env.SDK_API_KEY_ID`                      | The SDK_API_KEY_ID                                | `sdk-api-key-id in service-delete-manager-api-credentials secret`                 |
| `flowcore-microservices.deployments.serviceDeleteManagerApi.env.LOCK_REDIS_URL`                      | The LOCK_REDIS_URL                                | `lock-redis-url in service-delete-manager-api-credentials secret`                 |
| `flowcore-microservices.deployments.serviceDeleteManagerApi.env.QUEUE_REDIS_URL`                     | The QUEUE_REDIS_URL                               | `queue-redis-url in service-delete-manager-api-credentials secret`                |
...
| `flowcore-microservices.deployments.serviceDeleteManagerApi.env.CASSANDRA_USERNAME`                  | The CASSANDRA_USERNAME                            | `cassandra-username in service-delete-manager-api-credentials secret`             |
| `flowcore-microservices.deployments.serviceDeleteManagerApi.env.CASSANDRA_PASSWORD`                  | The CASSANDRA_PASSWORD                            | `cassandra-password in service-delete-manager-api-credentials secret`             |
