...
| `flowcore-microservices.deployments.legacyClientEventSourceApi.deployment.replicas`                        | The number of replicas                                | `1`                                                                          |
...
| `flowcore-microservices.deployments.legacyClientEventSourceApi.env.HOT_STORAGE_RETENTION`                  | The hot storage retention                             | `7`                                                                          |
...
| `flowcore-microservices.deployments.legacyPlatformEventSourceApi.deployment.replicas`                        | The number of replicas                                  | `1`                                                                          |
...
| `flowcore-microservices.deployments.legacyPlatformEventSourceApi.env.HOT_STORAGE_RETENTION`                  | The hot storage retention                               | `7`                                                                          |
